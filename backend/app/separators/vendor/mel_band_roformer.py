...
from .mel_filter import fixed_slaney_mel
...
class MelBandRoformer(Module):
    ...
    def __init__(
        ...
        *,
        ...
        mel_filter_bank_numpy = fixed_slaney_mel(
            sr=sample_rate,
            n_fft=stft_n_fft,
            n_mels=num_bands,
        )
    ...
    def forward(self, raw_audio, target=None, return_loss_breakdown=False):
        ...
        if raw_audio.device.type != "cpu":
            raise RuntimeError("MelBand RoFormer inference is CPU-only.")
